...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #background, could not get working
        background = pygame.image.load('Python Projects/Alien Invasion/images/stars.webp')
        ...
        #set the background color - colors are RGB colors: a mix of red, green, and blue. From 0 to 255
        self.bg_color = (100, 0, 100)
    ...
    def run_game(self):
        ...
        while True:
            # call a method to check to see if any keyboard events have occured
            self._check_events()
    ...
    def display_score(self, x, y):
        self.font = pygame.font.SysFont('Starjedi', 40)
    ...
    def _check_bullet_alien_collisions(self):
        ...
        #if an alien is hit, add 1 to the score
        if collisions:
            #add 1 to the score
            self.stats.score += 1
